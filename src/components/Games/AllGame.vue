<template>
  <div class="box"> 
    ...
    <div class="box__header">
      ...
      <div class="box__attr">
        <div class="box__search">
          ...
          <input type="text" placeholder="Поиск по играм" v-model="search" />
        </div>
        <div class="box__box">
          <small class="box__title box__title--box">Сортировка</small>
          <select name="" id="" class="select" @change="changeSortType($event)">
            <option 
    ...
    <div class="card">
      <div class="card__item" v-for="game in searchList" :key="game._id">
