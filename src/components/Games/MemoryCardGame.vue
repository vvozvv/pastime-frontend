    ...
    <div id="box-game" class="box-game">
      <div class="box-game__col" :class="{'box-game__col--full': fullWidthColumnsGame}">
        <ul class="memory-card-list" >
          ...
          @click="flipCard(card)">
            <div class="memory-card-list__front"></div>
      ...
      <div class="box-game__col box-game__col--description">
        ...
        <rate @changedRateParent="changeRate" :disabled="started"></rate>
        <button class="btn" @click="shuffle" v-show="!started">Перемешать</button>
      </div>
    </div>
  </div>
</template>
